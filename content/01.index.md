...
description: PitaMai Technology / ピタマイ・テクノロジー 公式サイト
navigation:
  title: ホーム
  icon: i-lucide-house
sitemap:
...
::tabs
  ...
  :::tabs-item{label="内製のツール"}
  ### 内製システム

  Better AuthとNuxtを用いた、内製のツール
  :::
::
...
::accordion
  :::accordion-item{label="2026年03月01日 投票により、定款が変更、代表交代"}
  [定款](/organization/kiyaku)をご覧ください。
  また、それに伴い[組織概要](https://pitamai.com/organization/overview)が変更されました
  :::
